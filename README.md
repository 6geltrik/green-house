...
5. Επειδή το καλοκαίρι θέλουμε ίσκιο για δροσιά και τον χειμώνα ήλιο για ζέστη, θα κατασκευάσουμε την στέγη της βεράντας με πτυσσόμενες περσίδες που θα προσανατολίζονται με τον ήλιο κατά το διάστημα της ημέρας για τον χειμώνα και κλειστές για το καλοκαίρι, ώστε να εξυπηρετούνται τα παραπάνω
Όλες οι παραπάνω συνδέσεις των ενεργειακών πηγών ελέγχονται με ένα μικροεπεξεργαστή arduino. ( Η τάση που θα χρησιμοποιήσουμε βέβαια θα είναι 12volt για λόγους ασφάλειας).
...
Την παρουσίαση και λειτουργία της κατασκευής την βλέπουμε στο YouTube: https://youtu.be/-uFoN2Z4CdY
